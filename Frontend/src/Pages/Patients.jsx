import { FaEye, FaPencil, FaTrashCan, FaBookMedical } from 'react-icons/fa6';
        ...
        <div className='grid grid-cols-3 gap-4'>
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
                    ...
                    <input type='text' placeholder='Vui lòng nhập họ và tên' className='input input-bordered w-full' />
                </label>
            </div>
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
            ...
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
                    ...
                    <input type='number' placeholder='Vui lòng nhập số tuổi' className='input input-bordered w-full' />
                </label>
            </div>
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
                    ...
                    <input type='text' placeholder='Vui lòng nhập địa chỉ' className='input input-bordered w-full' />
                </label>
            </div>
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
            ...
            <div className='col-span-3 xl:col-span-1'>
                <label className='form-control w-full'>
                    ...
                    <input type='date' placeholder='Vui lòng nhập ngày sinh' className='input input-bordered w-full' />
                </label>
            </div>
                            ...
                            <tr className='hover'>
                                ...
                                <th>
                                    ...
                                    <Link to='/masterdata/history'>
                                        <button className='btn btn-ghost tooltip tooltip-info' data-tip='Sổ khám bệnh'>
